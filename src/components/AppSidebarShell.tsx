...
const NAV_ITEMS: NavItemDef[] = [
  ...
  { href: '/app', icon: <BriefcaseBusiness className="h-4 w-4" />, label: 'My jobs' },
  { href: '/app', icon: <Search className="h-4 w-4" />, label: 'Find a professional' },
  { href: '/app', icon: <ShieldCheck className="h-4 w-4" />, label: 'Protection' },
]
        ...
        >
          {!collapsed && (
            <>
              ...
              <span className="flex-1 font-semibold text-sm truncate">fix<span className="text-accent">now</span></span>
            </>
          )}
          <Tooltip>
